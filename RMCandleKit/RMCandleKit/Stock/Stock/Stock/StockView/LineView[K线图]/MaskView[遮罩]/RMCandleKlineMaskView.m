...
@implementation RMCandleKlineMaskView
...
- (void)drawDashLine {
    ...
    //绘制选中价格
    NSString *priceText = [NSString stringWithFormat:RMCandleConStant.sharedInstance.accuracy,[[self.selectedModel Close] floatValue]];
