...
@interface RMCandleTopBarView() <UIScrollViewDelegate>
...
@implementation RMCandleTopBarView
...
//        scrollView.backgroundColor = [UIColor colorWithRed:235.0/255 green:235.0/255 blue:235.0/255 alpha:1.f];
...
- (void)setupHeadView {
    ...
    line.backgroundColor = [UIColor colorWithRed:9.0/255 green:10.0/255 blue:13.0/255 alpha:1];
...
- (void)didClickBtnAction:(UIButton *)btn {
    if (self.selectedIndex != btn.tag-100) {
        ...
        if ([self.delegate respondsToSelector:@selector(RMCandleTopBarView:didSelectedIndex:)]) {
            [self.delegate RMCandleTopBarView:self didSelectedIndex:btn.tag-100];
        }
