...
@implementation RMCandleKlineView
...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.drawPositionModels.count > 0) {
        RMCandleKline *line = [[RMCandleKline alloc] initWithContext:ctx drawModels:self.drawLineModels linePositionModels:self.drawPositionModels];
        [line draw];
    }
...
- (NSArray *)convertToPositionModelsWithXPosition:(CGFloat)startX drawLineModels:(NSArray <id<RMCandleLineDataModelProtocol>>*)drawLineModels  maxValue:(CGFloat)maxValue minValue:(CGFloat)minValue {
...
//            }
            if(openPoint.y > closePointY) {
                ...
                if(idx > 0) {
                    id<RMCandleLineDataModelProtocol> preKLineModel = drawLineModels[idx-1];
                    ...
                    id<RMCandleLineDataModelProtocol> subKLineModel = drawLineModels[idx+1];
        ...
        RMCandleLinePositionModel *positionModel = [RMCandleLinePositionModel modelWithOpen:openPoint close:closePoint high:highPoint low:lowPoint];
