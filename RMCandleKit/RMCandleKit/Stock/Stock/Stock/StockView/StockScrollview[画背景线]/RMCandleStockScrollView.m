...
@implementation RMCandleStockScrollView
...
- (void)drawBgLines {
    if (self.stockType == YYStockTypeLine) {
        ...
        CGFloat unitHeight = (self.frame.size.height*[RMCandleStockVariable lineMainViewRadio])/4;
        ...
        const CGPoint line6[] = {CGPointMake(0, self.frame.size.height * (1 - [RMCandleStockVariable volumeViewRadio]) ),CGPointMake(self.contentSize.width, self.frame.size.height * (1 - [RMCandleStockVariable volumeViewRadio]))};
    ...
    if (self.stockType == YYStockTypeTimeLine) {
        ...
        CGFloat unitHeight = (self.frame.size.height*[RMCandleStockVariable lineMainViewRadio])/2;
        ...
        const CGPoint line2[] = {CGPointMake(0, self.frame.size.height * [RMCandleStockVariable lineMainViewRadio] ),CGPointMake(self.frame.size.width, self.frame.size.height * [RMCandleStockVariable lineMainViewRadio])};
        CGContextStrokeLineSegments(ctx, line2, 2);
        
        
//        CGContextMoveToPoint(ctx, 0, self.frame.size.height * ([RMCandleStockVariable lineMainViewRadio] + [RMCandleStockVariable volumeViewRadio]) - 1);
//        CGContextAddLineToPoint(ctx, self.frame.size.width, self.frame.size.height * ([RMCandleStockVariable lineMainViewRadio] + [RMCandleStockVariable volumeViewRadio]) - 1);
